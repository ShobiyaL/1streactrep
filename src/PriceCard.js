        ...
        <div className="card mb-5 mb-lg-0">
            <div className="card-body">
              ...
              <ul className="fa-ul">
                ...
                <li className={props.data.isReport?"":"text-muted"}><span className="fa-li"><i className={props.data.isReport?"fas fa-check":"fas fa-times"}></i></span>{props.data.statusReport}
                 </li>
              </ul>
